...
CREATE TABLE `ims_card` (
  ...
  `cardname` varchar(50) NOT NULL COMMENT '明信片名称',
  ...
  `wechat` varchar(50) NOT NULL COMMENT '微信号码',
  `model` varchar(50) NOT NULL COMMENT '模板',
  `qrcode` varchar(200) NOT NULL COMMENT '二维码图片',
  `qrcodeurl` varchar(500) NOT NULL COMMENT '二维码地址',
  `headimg` varchar(255) NOT NULL COMMENT '头像',
  `headimgurl` varchar(500) NOT NULL COMMENT '地址',
  `pic` varchar(200) NOT NULL COMMENT '名片合成图',
  `picurl` varchar(500) NOT NULL COMMENT '名片合成图地址',
  `font` varchar(100) NOT NULL COMMENT '字体',
  `fontcolor` varchar(100) NOT NULL COMMENT '字体颜色',
  `colortype` varchar(50) NOT NULL COMMENT '名片背景颜色',
  `image` varchar(500) NOT NULL COMMENT 'logo头像',
  `baseimage` varchar(500) NOT NULL COMMENT '底图',
  `logo` varchar(255) NOT NULL COMMENT '底图logo,png',
  `logourl` varchar(500) NOT NULL COMMENT '底图logo地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

CREATE TABLE `ims_card_user` (
  ...
  `sex` tinyint(2) NOT NULL DEFAULT '1' COMMENT '1,男0,女',
...
CREATE TABLE `ims_nets_hjkcms_global` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL COMMENT '公众号ID',
  `logo` text COMMENT 'LOGO图标',
  `title` text COMMENT '分享图标',
  `remark` text COMMENT '分享描述',
  `jdappid` varchar(50) DEFAULT NULL COMMENT '京东appid',
  `jdappkey` varchar(200) DEFAULT NULL COMMENT '京东key',
...
CREATE TABLE `ims_we7_enterprise_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ims_we7_enterprise_setting` (
  `key` varchar(100) NOT NULL,
  `value` text,
  `uniacid` int(11) NOT NULL,
  KEY `key` (`key`)
...
CREATE TABLE `ims_wei_qian_award` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `weid` int(11) NOT NULL,
  `orderid` int(11) DEFAULT '0' COMMENT '排序',
  `number` int(11) DEFAULT '0' COMMENT '连续签到天数',
  `integral` int(11) DEFAULT '0' COMMENT '奖励积分',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wei_qian_from` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `fmopenid` varchar(200) DEFAULT NULL COMMENT '排序',
  `yuopenid` varchar(200) DEFAULT NULL COMMENT '连续签到天数',
  `time` varchar(200) DEFAULT NULL COMMENT '奖励积分',
  `xhm` varchar(255) DEFAULT NULL,
  `ishiyong` int(11) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wei_qian_fxjilu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` varchar(5) NOT NULL,
  `openid` varchar(50) NOT NULL,
...
CREATE TABLE `ims_wei_qian_jilu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `ip` varchar(255) DEFAULT NULL,
  `jingbi` int(11) DEFAULT '0',
  `shengfu` varchar(255) DEFAULT NULL,
  `yz` varchar(255) DEFAULT '0',
  `baidu` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `time` (`time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wei_qian_lianxujilu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nickname` varchar(40) NOT NULL DEFAULT '',
  `avatar` varchar(400) NOT NULL DEFAULT '',
  `fen` int(11) NOT NULL DEFAULT '0',
  ...
  `ip` varchar(255) DEFAULT NULL,
  `jingbi` int(11) DEFAULT '0',
  `cis` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wei_qian_paylog` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  ...
  `jopenid` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wei_qian_peizhi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chishu` int(11) NOT NULL,
  `credit` int(11) NOT NULL DEFAULT '1',
  `paitiaoshu` int(11) NOT NULL,
  `start_time` varchar(50) NOT NULL DEFAULT '0',
  `end_time` varchar(50) NOT NULL DEFAULT '0',
  `uniacid` int(11) NOT NULL,
  `jingbi` int(11) DEFAULT '0',
  `fenxiangtitle` varchar(255) DEFAULT NULL,
  `fenxiangshuoming` varchar(255) DEFAULT NULL,
  `fengxiangimg` varchar(255) DEFAULT NULL,
  `shangcheng` varchar(255) DEFAULT NULL,
  `jingyong` tinyint(3) DEFAULT '1',
  `huodong_sm` longtext,
  `biejingimg` varchar(300) DEFAULT NULL,
  `mchid` varchar(255) DEFAULT NULL,
  `apikey` varchar(255) DEFAULT NULL,
  `appid` varchar(255) DEFAULT NULL,
  `secret` varchar(255) DEFAULT NULL,
  `fen` int(11) DEFAULT NULL,
  `scziduan` varchar(255) DEFAULT NULL,
  `yanse` varchar(255) DEFAULT NULL,
  `audio` varchar(500) DEFAULT NULL,
  `carry` tinyint(3) DEFAULT '1',
  `times` varchar(255) DEFAULT NULL,
  `diqu` varchar(500) DEFAULT NULL,
  `baidukey` varchar(255) DEFAULT NULL,
  `isfollow` tinyint(3) DEFAULT '1',
  `title` varchar(255) DEFAULT NULL,
  `fxcredit` int(11) DEFAULT '0',
  `qdbt` varchar(255) DEFAULT NULL,
  `sjdcredit` tinyint(3) DEFAULT '0',
  `sjxcredit` tinyint(3) DEFAULT '0',
  `timek` varchar(255) DEFAULT NULL,
  `timej` varchar(255) DEFAULT NULL,
  `zdcredit` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ims_xc_enterprise_mess` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  `tel` bigint(20) DEFAULT NULL COMMENT '电话',
  `status` int(11) DEFAULT '-1' COMMENT '状态（1已回复-1未回复）',
  `email` varchar(100) DEFAULT NULL COMMENT '邮箱',
  `contents` varchar(500) DEFAULT NULL COMMENT '反馈内容',
...
CREATE TABLE `ims_xc_enterprise_news` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  ...
  `img` varchar(255) DEFAULT NULL COMMENT '展示小图',
  `about` varchar(500) DEFAULT NULL COMMENT '新闻简介',
  `add` varchar(255) DEFAULT NULL COMMENT '附加内容',
  `isindex` int(11) DEFAULT '-1' COMMENT '首页显示',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

CREATE TABLE `ims_xc_enterprise_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL COMMENT '名称',
  `keyval` varchar(50) DEFAULT NULL COMMENT '关键字',
...
CREATE TABLE `ims_xc_enterprise_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  `contents` mediumtext NOT NULL COMMENT '产品内容',
  `createtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `name` varchar(50) DEFAULT NULL COMMENT '名称',
  `model` varchar(50) DEFAULT NULL COMMENT '型号',
  `cid` varchar(255) DEFAULT NULL COMMENT '分类',
  `simg` varchar(255) DEFAULT NULL COMMENT '展示图片',
  `imgs` varchar(255) DEFAULT NULL COMMENT '相册',
