...
CREATE TABLE `ims_card_set` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `unionid` varchar(64) NOT NULL DEFAULT '',
  `openid` varchar(64) NOT NULL DEFAULT '',
  `sharetitle` varchar(32) NOT NULL DEFAULT '',
  `sharedesc` varchar(256) NOT NULL DEFAULT '',
  `shareimg` varchar(256) NOT NULL DEFAULT '',
  `advertisementimg` varchar(256) NOT NULL DEFAULT '',
  `advertisementurl` varchar(256) NOT NULL DEFAULT '',
...
CREATE TABLE `ims_share_card_catalogs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ims_share_card_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ims_share_card_notices` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ims_share_card_products` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ims_share_card_setting` (
  `key` varchar(100) NOT NULL,
  `value` text,
  `uniacid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `ims_share_card_users` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ims_we7_wxappsample_riji` (
...
CREATE TABLE `ims_wzq_tplmessage_apiseng` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `message` text,
  `uniacid` int(10) DEFAULT NULL,
  `status` int(2) DEFAULT NULL COMMENT '状态 0为发送中 1为完成 2为失败',
  `time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wzq_tplmessage_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tid` int(11) DEFAULT NULL COMMENT '模板本地id',
  `message` text COMMENT '消息内容',
  `time` int(11) DEFAULT NULL,
  `uniacid` int(11) DEFAULT NULL,
  `tpl_title` varchar(80) DEFAULT NULL,
  `tpl_key` text,
  `tpl_type` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wzq_tplmessage_sendlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `istiming` int(2) DEFAULT '0',
  `logurl` int(1) DEFAULT '0',
  `views` int(11) DEFAULT '0',
  `tpl_type` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=82 DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wzq_tplmessage_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wxapp_id` varchar(80) DEFAULT NULL,
  `wxapp_name` varchar(500) DEFAULT NULL COMMENT '小程序名称',
  `uniacid` int(5) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

CREATE TABLE `ims_wzq_tplmessage_tpllist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `uniacid` int(5) DEFAULT NULL,
  `tpl_primary_industry` varchar(100) DEFAULT NULL,
  `tpl_deputy_industry` varchar(100) DEFAULT NULL,
